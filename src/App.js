...
function App() {
  ...
  let iconMusicPlay = <svg focusable="false" aria-hidden="true" viewBox="0 0 24 24" className="icon-play"><path fill="#fff" d="M12 3v10.55c-.59-.34-1.27-.55-2-.55-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4V7h4V3h-6z"></path></svg>

  let iconMusicPause = <svg focusable="false" aria-hidden="true" viewBox="0 0 24 24" className="icon-pause">
